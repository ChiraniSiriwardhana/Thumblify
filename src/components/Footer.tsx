...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <Link to="/">
                    <img className="size-8 aspect-square" src="/favicon1.svg" alt="footer logo" width={32} height={32} />
                </Link>
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-3">
                    {/* <a href="https://dribbble.com/prebuiltui" target="_blank" rel="noreferrer"></a> */}
                        <DribbbleIcon className="size-5 hover:text-pink-500" />
                    
                    {/* <a href="https://www.linkedin.com/company/prebuiltui" target="_blank" rel="noreferrer"></a> */}
                        <LinkedinIcon className="size-5 hover:text-pink-500" />
                    
                    {/* <a href="https://x.com/prebuiltui" target="_blank" rel="noreferrer"></a> */}
                        <TwitterIcon className="size-5 hover:text-pink-500" />
                    
                    {/* <a href="https://www.youtube.com/@prebuiltui" target="_blank" rel="noreferrer"></a> */}
